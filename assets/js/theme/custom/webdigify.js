...
$(document).ready(function(){
	...
	$('.topbanner .ttcmsofferbanner').insertBefore('.tt-featured');
	$('.topbanner .ttcmssubbanner').insertBefore('.allcategories');
...
function morelinks(){
	var max_link;
		...
		var moretext= "More";
		var items = $('.tt-header-content #menu-link div.navPages-item-page');
		...
		jQuery(".tt-header-content #menu-link div.navPages-item-page").hover(function() {
